...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='company_type',
            field=models.CharField(blank=True, choices=[('startup', 'Startup'), ('corporation', 'Corporation')], default='startup', max_length=50, null=True),
        ),
        migrations.AddField(
            model_name='user',
